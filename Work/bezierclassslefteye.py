...
##        img = cv2.imread('Drawpoint\Lipa\Lips185.jpg')
        data=[['leftwidth','leftheight','leftangle']]
        path='lifteye.csv'
        counter=0
        with open(path) as csvfile:
             ...
             for row in readCSV:
                 ...
                 #############
                  ...
                  u=0
                  beziercurvelefteye._bezier_curve(p0,p1,p2,p3,u,img,counter)
                  width=beziercurvelefteye._distance(p0,p2)
                  print(width)
                  height=beziercurvelefteye._distance(p1,p3)
                  print(height)
                  angle=beziercurvelefteye._angle(p0,p1,p2,width,height)
