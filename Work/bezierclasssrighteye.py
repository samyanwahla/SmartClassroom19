...
##        img = cv2.imread('Drawpoint\Lipa\Lips185.jpg')
        ...
        with open(path) as csvfile:
             ...
             for row in readCSV:
                 ...
                 #############
                  ...
                  u=0
                  beziercurverighteye._bezier_curve(p0,p1,p2,p3,u,img,counter)
                  width=beziercurverighteye._distance(p0,p2)
                  print(width)
                  height=beziercurverighteye._distance(p1,p3)
                  print(height)
                  angle=beziercurverighteye._angle(p0,p1,p2,width,height)
        ...
        with open('Features1.csv','w',newline='\n') as fp:
